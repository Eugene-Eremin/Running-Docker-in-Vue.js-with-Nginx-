<template>
    <v-container>
        <v-row justify="center" align="center">
            <v-col cols="auto">
                <v-text-field v-model="from" type="number" size="x-large" @change="change"
                    :label="areasOfWork.name + ' (от)'" :rules="countRules" variant="underlined"></v-text-field>
            </v-col>
            <v-col cols="auto">
                <v-text-field v-model="to" type="number" size="x-large" @change="change" :label="areasOfWork.name + ' (до)'"
                    :rules="countRules" variant="underlined"></v-text-field>
            </v-col>
        </v-row>
    </v-container>
</template>
